...
// NOTE: no profile param on the pending/usage readers — they are handed to
// useQuery verbatim as queryFn, and React Query would pass its query context
// object into a first function parameter (misread as a ProfileScope). Ambient
// scope (capabilityScoped()) already covers the active profile.
